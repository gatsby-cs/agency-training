...
export const onPostBuild = () => {
  // fire some action after the build is complete
}
export const onPreBootstrap = () => {
  // fire some action early in the build
}
export const onCreateNode = () => {
  // called when a node is created
  // often used for extending nodes from another plugin
}
export const onCreateWebpackConfig = () => {
  // used to set or override the webpack config
}
//
